...
def main():
    ...
    print(DELIMITER)
    print('acc - {}'.format(accuracy(classifier_answers, test_correct_answers)))
    print('prec - {}'.format(precision(classifier_answers, test_correct_answers)))
    print('rec - {}'.format(recall(classifier_answers, test_correct_answers)))
